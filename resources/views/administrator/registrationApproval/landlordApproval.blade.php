...
@section('title', 'Advertiser Approval List')

@section('content')
<h1>Advertiser Registration List</h1>
        ...
        <tbody>
            @foreach ($advertisers as $index => $advertiser)
                <tr>
                    ...
                    <td style="border: 1px solid black; padding: 10px;">{{ $advertiser->registration_status }}</td>
                    <td style="border: 1px solid black; padding: 10px;">

                        <div class="d-inline-block">
                            <a href="{{ route('showAdvertiserApp', $advertiser->advertiser_id)}}" class="btn btn-info btn-sm">View</a>
                        </div>
                    </td>
                </tr>
            @endforeach
