    ...
    <table style="border-collapse: collapse;">
        <thead>
            <tr>
                ...
                <th style="border: 1px solid black; padding-right: 40px; padding-left:10px;">Tenant Status</th>
        ...
        <tbody>
            @foreach ($tenants as $index => $tenant)
                <tr>
                    ...
                    <td style="border: 1px solid black; padding: 10px;">{{ $tenant->tenant_status }}</td>
                    <td style="border: 1px solid black; padding: 10px;">

                        <div class="d-inline-block">
                            <a href="{{ route('showTenant', $tenant->tenant_id)}}" class="btn btn-info btn-sm">View</a>
                        </div>
                    </td>
                </tr>
            @endforeach
