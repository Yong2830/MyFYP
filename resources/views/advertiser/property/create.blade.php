...
@section('title', 'Create New Property Listings')
@if ($errors->any())
            ...
            <div class="col-md-6 mx-auto mt-5">
                ...
                <form class="form" method="POST" action="{{ route('property.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="food_photo" class="col-sm-3 col-form-label">Property Images:</label>
                        <div class="col-sm-9">
                            <input type="file" class="form-control" name="property_image1" accept="image/*">
                            <br>
                            <img id="preview-img" src="#" alt="Preview Image"
                                style="display: none; height:200px; width: 250px;">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="property_name" name="property_name"
                                maxlength="50" value="{{ old('property_name') }}">
                            @error('property_name')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="property_address" name="property_address"
                                maxlength="100" value="{{ old('property_address') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="property_postal" name="property_postal"
                                value="{{ old('property_postal') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="property_number_room"
                                name="property_number_room" value="{{ old('property_number_room') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="property_rental_status"
                                name="property_rental_status" value="Vacant" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" id="property_description" name="property_description" rows="4">{{ old('property_description') }}</textarea>
                        </div>
